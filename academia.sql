...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 27, 2020 at 06:28 PM
...
(42, 'admin', '202cb962ac59075b964b07152d234b70');
...
--
ALTER TABLE `user_weight`
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`fk_user`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
