...
if (isset($_POST['weight'])) {
  $weight = new User();
  $res = $weight->setWeight($_POST['weight']);
}
?>  
<!DOCTYPE html>
<html lang="pt-br">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        <a class="navbar-brand" href="javascript:;">Cadastro de peso</a>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-info">
                                    <h4 class="card-title">Cadastro de peso</h4>
                                    <p class="card-category">Digite o seu peso atual</p>
                                </div>
                                <div class="card-body">
                                    <form method="POST">
                                    ...
                                    <?php
                                      ...
                                      <div class="alert alert-success m-2" id="res" style='<?php echo $display; ?>' ><?php echo $res;?></div>
                                </div>
                            </div>
                        </div>
                    </div>
